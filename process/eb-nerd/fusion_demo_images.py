...
news.rename_col('image_caption_text', 'image_caption_text_token')
...
news_llama.rename_col('image_caption_text', 'image_caption_text_llama')

news.inject(news_llama, ['title-llama', 'subtitle-llama', 'body-llama', 'category-llama', 'image_caption_text_llama'])
